        ...
        <div class="kt-widget__body">
          ...
          <div class="kt-widget__item">
            <div class="kt-widget__contact">
              <span class="kt-widget__label">@lang('user.field.satker'):</span>
              <a href="javascript::void(0)" class="kt-widget__data">{{$data->satker->name}}</a>
            </div>
            <div class="kt-widget__contact">
            ...
            <div class="kt-widget__contact">
              <span class="kt-widget__label">@lang('user.field.phone'):</span>
              <a href="javascript::void(0)" class="kt-widget__data">{{$data->no_hp ? $data->no_hp : '000 0000 0000' }}</a>
            </div>
            <div class="kt-widget__contact">
