<div class="kt-section__body">
  ...
  <div class="form-group row">
    <label class="col-xl-3 col-lg-3 col-form-label">@lang('user.field.satker')</label>
    <div class="col-lg-9 col-xl-6">
      @if (Request::is('*edit'))
        {!! Form::select('satuan_kerja', $satker, $data->satker ? $data->satker->id : '', ['class' => 'form-control kt-select2', 'id'=>'kt_select2_1','required'=>'required']) !!}
        @error('satuan_kerja')
          <div class="form-text text-danger">{{$message}}</div>
        @enderror
      @else
        {!! Form::select('satuan_kerja', $satker, null, ['class' => 'form-control kt-select2', 'id'=>'kt_select2_2','required'=>'required']) !!}
        @error('satuan_kerja')
          <div class="form-text text-danger">{{$message}}</div>
        @enderror
      @endif
