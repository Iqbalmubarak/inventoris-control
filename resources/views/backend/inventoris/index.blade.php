...
@section('subheader-btn')
  <a href="javascript:void(0)" onclick="cetak()" class="btn btn-success btn-bold">
		...
		<form class="kt-form kt-form--fit kt-margin-b-20">
			<div class="row kt-margin-b-20">
				<div class="col-lg-3 kt-margin-b-10-tablet-and-mobile">
					<label>@lang('inventoris.field.satker'):</label>
...
<!--begin::Modal-->
<div class="modal fade" id="f_modal_cetak" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      {{ Form::open(array('method'=>'GET','target'=>'_blank', 'url' => route('inventoris.cetak'), 'files' => true, 'id'=>'form_inventorisDetail_create')) }}
        <div class="modal-body">
          <div class="col-md-12">
            <div class="kt-form__group--inline">
              <div class="kt-form__label">
                <label class="kt-label m-label--single">@lang('inventoris.field.satker'):</label>
              </div>
              <div class="kt-form__control">
              {!! Form::select('satker', $satker,null, ['class' => 'form-control kt-select2 myselect2','required'=>'required']) !!}
                @error('satker')
          ...
          <div class="col-md-12">
            <div class="kt-form__group--inline">
              <div class="kt-form__label">
                <label class="kt-label m-label--single">@lang('inventoris.field.tanggal_awal'):</label>
              </div>
              <div class="kt-form__control">
                <input type="date" name="tanggal_awal" class="form-control" placeholder="Enter number" id="d_tanggal_awal">
                @error('tanggal_awal')
                  <div class="form-text text-danger">{{$message}}</div>
                @enderror
              </div>
          ...
          <div class="col-md-12">
            <div class="kt-form__group--inline">
              <div class="kt-form__label">
                <label class="kt-label m-label--single">@lang('inventoris.field.tanggal_akhir'):</label>
              </div>
              <div class="kt-form__control">
                <input type="date" name="tanggal_akhir" class="form-control" placeholder="Enter number" id="d_tanggal_akhir">
                @error('tanggal_akhir')
                  <div class="form-text text-danger">{{$message}}</div>
                @enderror
              </div>
...
<script type="text/javascript">
  ...
  $('#f_modal_cetak').on('shown.bs.modal', function () {
      $(".myselect2").select2({
