  ...
  <div class="col-xl-12">
    ...
    <div class="kt-portlet text-center">
      <div class="kt-portlet__body text-center">
        <h1>Selamat Datang Di Aplikasi Inventori APD @if(Sentinel::getUser()->roles()->first()->id==2)  {{Sentinel::getUser()->roles()->first()->name}} @elseif(Sentinel::getUser()->roles()->first()->id==3) {{Sentinel::getUser()->satker->name}} @endif </h1>
        <h3>Aplikasi Ini Masih Dalam <span class="kt-font-warning">Pengembangan</span> Silakan Lakukan Percobaa Pada Aplikasi Ini</h3>
        <h4>Jika Menemukan Kendala <span class="kt-font-success">Harapan Kami</span> Bisa Memberikan Kritik dan Sarannya ke "apd.padang@gmail.com"</h4>
      </div>
    </div>
