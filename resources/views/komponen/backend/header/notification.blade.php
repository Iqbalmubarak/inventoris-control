<?php
    ...
    ->select('inventoris_request.id','inventoris_request.updated_at','satuan_kerja.name','inventoris_request.satker_id','inventoris_request.status','inventoris_request.created_at')->get();
    $message = 0;
    $tanggal = now();
    ...
    if(Sentinel::getUser()->satker->id==1){
      foreach($masuk as $in){
        ...
        $total = $in->total - $keluar->sum('total');
        if($total<=3 && $total>0){
          $message++;
        }
        elseif($total<=0){
            ...
            <div class="tab-pane" id="topbar_notifications_events" role="tabpanel">
              ...
              @foreach($stats as $stat)
                ...
                <a href="{{route('inreq.show',[$stat->id])}}" class="kt-notification__item">
                  ...
                  <div class="kt-notification__item-details">
                    <div class="kt-notification__item-title">
                      @lang('notification.r_field.r_order')
                    </div>
                ...
                <a href="{{route('inreq.show',[$stat->id])}}" class="kt-notification__item">
                  ...
                  <div class="kt-notification__item-details">
                    <div class="kt-notification__item-title">
                      @lang('notification.r_field.r_acc')
                    </div>
                    <div class="kt-notification__item-time">
                    {{$stat->updated_at}}
                    </div>
                ...
                <a href="{{route('inreq.show',[$stat->id])}}" class="kt-notification__item">
                  ...
                  <div class="kt-notification__item-details">
                    <div class="kt-notification__item-title">
                      @lang('notification.r_field.r_request')
                    </div>
                    <div class="kt-notification__item-time">
                      {{$stat->created_at}}
                    </div>
                ...
                <a href="{{route('inreq.show',[$stat->id])}}" class="kt-notification__item">
                  ...
                  <div class="kt-notification__item-details">
                    <div class="kt-notification__item-title">
                      @lang('notification.r_field.r_reject1') @lang('notification.r_field.r_reject2')
                    </div>
                    <div class="kt-notification__item-time">
                      {{$stat->updated_at}}
                    </div>
